        ...
        return args -> {
            ...
            if (p1 == null) {
                p1 = Producto.builder()
                        ...
                        .precio(25000.0)
                        .stock(50)
                        .imagenUrl("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpvnJ9VZ42GCh-wgkNf1FjLMZi9DTeIII31nUUf0YiqEI2VeowXeVlNKYZ&s=10")
                        .talle("L")
                        .color("Negro")
                        .categoria(remeras)
                        .creador(creador)
            ...
            if (p2 == null) {
                p2 = Producto.builder()
                        ...
                        .precio(45000.0)
                        .stock(20)
                        .imagenUrl("https://acdn-us.mitiendanube.com/stores/001/218/661/products/25425-23-1-b975a186e3b86d63e617177845957926-1024-1024.webp")
                        .talle("42")
                        .color("Verde")
